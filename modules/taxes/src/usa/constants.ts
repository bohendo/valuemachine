...
import { DecString, IntString } from "@valuemachine/types";
...
export const getTaxBrackets = (year: IntString): {
  rate: DecString;
  single: IntString;
  joint: IntString;
  head: IntString;
  ...
  // should we log a warning or something if we're returning our best guess?
