...
export const f1040 = (oldForms: Forms): Forms => {
  ...
  f1040.L11b = subToZero(f1040.L8b, f1040.L11a);
  log.info(`Taxable Income: ${round(f1040.L11b)}`);
  ...
  if (!forms.f2555) {
    ...
    const L2c = add(f2555.L45, f2555.L50);
    const L3 = add(f1040.L11b, add());
    const L4 = getIncomeTax(L3, filingStatus);
    const L5 = getIncomeTax(L2c, filingStatus);
    f1040.L12a = subToZero(L4, L5);
  }
  ...
  f1040.L14 = subToZero(f1040.L12b, f1040.L13b);
  log.info(`Taxes Paid: ${round(f1040.L14)}`);
  ...
  f1040.L20 = subToZero(f1040.L19, f1040.L16);

  f1040.L23 = subToZero(f1040.L16, f1040.L19);
  log.info(`Taxes Owed: ${round(f1040.L23)}`);
