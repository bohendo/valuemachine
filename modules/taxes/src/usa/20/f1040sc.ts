...
export const f1040sc = (
  ...
  let totalIncome = "0";
  processIncome(taxRows, (income: TaxRow, value: DecString): void => {
  ...
  let exchangeFees = "0";
  processExpenses(taxRows, (expense: TaxRow, value: DecString): void => {
    ...
    if (!expense.tags.expenseType) { // TODO: filter out non-deductible?
      ...
      // TODO: only include fees paid to exchanges
