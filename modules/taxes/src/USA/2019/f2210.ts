...
export const f2210 = (forms: Forms, taxRows: TaxRows, logger: Logger): Forms => {
  ...
  columns.forEach(column => {
    ...
    if (f1040.Single || f1040.MarriedFilingSeparately) {
      f2210[getKey(14)] = applyTaxBracket("2019", getVal(13), FilingStatuses.Single);
    } else if (f1040.MarriedFilingJointly || f1040.QualifiedWidow) {
      f2210[getKey(14)] = applyTaxBracket("2019", getVal(13), FilingStatuses.Joint);
    } else if (f1040.HeadOfHousehold) {
      f2210[getKey(14)] = applyTaxBracket("2019", getVal(13), FilingStatuses.Head);
    }
