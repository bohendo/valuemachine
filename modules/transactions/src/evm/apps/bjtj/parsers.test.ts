...
describe(appName, () => {
  ...
  it("should handle a v1 deposit", async () => {
    const tx = await parseEthTx({
      hash: "0xaf24b14308013aab253a7e3abbc35ee3ad971371d476fee0cfbd39dcbee465e9",
  ...
  it("should handle a v1 withdraw", async () => {
    const tx = await parseEthTx({
      hash: "0xb09182b5687fa2dee5b216f2b719fa3a66e27117767de0868b8129c6db986687",
      selfAddress: "Ethereum/0x213fe7e177160991829a4d0a598a848d2448f384",
      logger: log,
    });
    expect(tx.apps).to.include(appName);
  ...
  it("should handle a v1 self destruct", async () => {
    const tx = await parseEthTx({
      hash: "0x4a4771995b71469253c3c9eb861854059ce113709a4b2e0325bdff630aeef474",
  ...
  it("should handle a v2 deposit", async () => {
    const tx = await parseEthTx({
      hash: "0x2c22e18f67642a22184354dc8f67bfc79103617f1f50e861bbd309606bbf0301",
  ...
  it("should handle a v2 withdraw", async () => {
    const tx = await parseEthTx({
      hash: "0x9f7342f3f37a9fa74857afd9c56e4a290af983758df8a937dcd78e2588ba6c4e",
      selfAddress: "Ethereum/0x1057Bea69c9ADD11c6e3dE296866AFf98366CFE3",
      logger: log,
    });
    expect(tx.apps).to.include(appName);
