...
describe(appName, () => {
  ...
  it("should parse a yearn deposit", async () => {
    const tx = await parseEthTx({
      hash: "0x92fa277dc5b620234c0c919533622ab2bef3e5c6fb56f27cc9d13cff9a7ae5e7",
  ...
  it("should parse a yearn withdraw", async () => {
    const tx = await parseEthTx({
      hash: "0x73762d63081ca3139a0a822236d87d02663100b62ba85ae76fc8bf17c46f56e2",
  ...
  it("should parse a yGov deposit", async () => { // deposit
    const tx = await parseEthTx({
      hash: "0x6afbee7183e3bf248ef32e4776723101b693cc30eafbed0eedabeada07f68bcd",
  ...
  it("should parse a yGov withdrawal", async () => { // withdraw
    const tx = await parseEthTx({
      hash: "0x1d88235000b0beecef8f91d96091632074626b2677fe83b8796a36fffa4d1f76",
      selfAddress: "0x09ea768029069eeb979015a64f261e7789e5e450",
      logger,
    });
    expect(tx.apps).to.include(appName);
  ...
  it("should parse a yGov registration", async () => { // withdraw
    const tx = await parseEthTx({
      hash: "0x57a9dd966cdf2289bc4cd68f66e7fa72918d37919d51b7998b844f710b026de2",
      selfAddress: "0x09ea768029069eeb979015a64f261e7789e5e450",
      logger,
    });
    expect(tx.apps).to.include(appName);
  ...
  it("should parse a yGov exit", async () => { // withdraw
    const tx = await parseEthTx({
      hash: "0x094536c4911eea329b3b9d890be4a27637d8d011612c9a37e66042b5f29ba2bd",
