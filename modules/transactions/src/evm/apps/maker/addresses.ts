...
const saiAddresses = [
  ...
  { name: Apps.SaiGemPit, address: "Ethereum/0x69076e44a9c70a67d5b79d95795aba299083c275" },
  { name: "SaiTap", address: "Ethereum/0xbda109309f9fafa6dd6a9cb9f1df4085b27ee8ef" },
  { name: Apps.SaiTub, address: "Ethereum/0x448a5065aebb8e423f0896e6c5d525c040f59af3" },
...
const daiAddresses = [
  ...
  { name: Apps.SaiToDaiVault, address: "Ethereum/0xc73e0383f3aff3215e6f04b0331d58cecf0ab849" },
  { name: Apps.DSR, address: "Ethereum/0x197e90f9fad81970ba7976f33cbd77088e5d7cf7" },
  { name: "DaiSaiJoin", address: "Ethereum/0xad37fd42185ba63009177058208dd1be4b136e6b" },
  { name: Apps.DaiVat, address: "Ethereum/0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b" },
...
export const saiAddress = addresses.find(e => e.name === Tokens.SAI)?.address;
export const pethAddress = addresses.find(e => e.name === Tokens.PETH)?.address;
export const tubAddress = addresses.find(e => e.name === Apps.SaiTub)?.address;
export const cageAddress = addresses.find(e => e.name === Apps.SaiCage)?.address;
export const saiPitAddress = addresses.find(e => e.name === Apps.SaiGemPit)?.address;
export const dsrAddress = addresses.find(e => e.name === Apps.DSR)?.address;
export const vatAddress = addresses.find(e => e.name === Apps.DaiVat)?.address;
export const migrationAddress = addresses.find(e => e.name === Apps.SaiToDaiVault)?.address;
