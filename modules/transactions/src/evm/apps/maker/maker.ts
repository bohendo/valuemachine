...
const tokenAddresses = [
  { name: SAI, address: "Ethereum/0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359" },
  { name: PETH, address: "Ethereum/0xf53ad2c6851052a81b42133467480961b2321c09" },
  { name: DAI, address: "Ethereum/0x6b175474e89094c44da98b954eedeac495271d0f" },
].map(setAddressCategory(AddressCategories.ERC20));

const govTokenAddresses = [
  { name: MKR, address: "Ethereum/0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2" },
].map(setAddressCategory(AddressCategories.ERC20));
