...
describe("VM", () => {
  ...
  it("should process out of order eth transfers gracefully", async () => {
    [getTestTx([ // Income
      { asset: ETH, category: Income, from: notMe, quantity: "1.0", to: ethAccount },
      ...
      { asset: ETH, category: Expense, from: ethAccount, quantity: "1.0", to: notMe },
      { asset: ETH, category: Expense, from: otherAccount, quantity: "1.0", to: notMe },
      { asset: ETH, category: Income, from: notMe, quantity: "1.0", to: ethAccount },
      { asset: ETH, category: Income, from: notMe, quantity: "2.0", to: otherAccount },
    ])].forEach(vm.execute);
  ...
  it("should emit an error event if swap accounts don't match", async () => {
    [getTestTx([ // Income
      ...
      { asset: UNI, category: SwapIn, from: notMe, quantity: "50.0", to: otherAccount },
    ])].forEach(vm.execute);
  ...
  it("should process borrowing & repaying a loan", async () => {
    [getTestTx([
      { asset: ETH, category: Income, from: notMe, quantity: "10.0", to: ethAccount },
    ]), getTestTx([
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: ETH, category: Internal, from: ethAccount, quantity: "2.0", to: aaveAccount },
    ]), getTestTx([
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: DAI, category: Borrow, from: aaveAccount, quantity: "200", to: ethAccount },
    ])].forEach(vm.execute);
    ...
    [getTestTx([
      { asset: DAI, category: Income, from: notMe, quantity: "10.0", to: aaveAccount },
    ]), getTestTx([
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: DAI, category: Repay, from: ethAccount, quantity: "200", to: aaveAccount },
      { asset: DAI, category: Fee, from: aaveAccount, quantity: "10", to: notMe },
    ])].forEach(vm.execute);
  ...
  it("should process a trade that includes a refund", async () => {
    ...
    [getTestTx([
      ...
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: asset, category: SwapOut, from: ethAccount, quantity: amount, to: notMe },
      { asset: UNI, category: SwapIn, from: notMe, quantity: "200.0", to: ethAccount },
      { asset: asset, category: Refund, from: notMe, quantity: refund, to: ethAccount },
    ])].forEach(vm.execute);
    ...
    expect(vm.json.chunks.find(chunk =>
      chunk.asset === asset && chunk.quantity === sub(amount, refund)
    )).to.not.be.undefined;
  });
  ...
  it("should process multiple incomes and trades before chainging guards", async () => {
    [getTestTx([ // Income
      ...
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: UNI, category: SwapOut, from: ethAccount, quantity: "200.0", to: notMe },
      { asset: ETH, category: SwapIn, from: notMe, quantity: "4.0", to: ethAccount },
  ...
  it("should process internal transfers between guards", async () => {
    [getTestTx([ // Income
      ...
      { asset: UNI, category: SwapIn, from: notMe, quantity: "50.0", to: ethAccount },
    ]), getTestTx([ // Trade UNI for ETH
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: UNI, category: SwapOut, from: ethAccount, quantity: "50.0", to: notMe },
  ...
  it("should process an investment into uniswap LP tokens", async () => {
    [getTestTx([ // Income
      ...
      { asset: ETH, category: SwapIn, from: notMe, quantity: "3.0", to: ethAccount },
      { asset: UNI, category: SwapIn, from: notMe, quantity: "75.0", to: ethAccount },
    ]), getTestTx([ // Trade UNI for ETH
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: UNI, category: SwapOut, from: ethAccount, quantity: "75.0", to: notMe },
  ...
  it("should emit an event when guards change", async () => {
    [getTestTx([
      ...
      { asset: ETH, category: Internal, from: ethAccount, quantity: "5.0", to: usdAccount },
    ]), getTestTx([
      { asset: ETH, category: Internal, from: usdAccount, quantity: "5.0", to: ethAccount },
    ])].forEach(vm.execute);
  ...
  it("should process a lone SwapIn as income", async () => {
    [getTestTx([ // Income
      ...
      { asset: ETH, category: Fee, from: ethAccount, quantity: "0.1", to: Ethereum },
      { asset: ETH, category: SwapOut, from: ethAccount, quantity: "5.0", to: notMe },
    ])].forEach(vm.execute);
