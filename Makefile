...
f1040.fdf: f1040_data_fields fdfgen scripts/fill-form.py
	python scripts/fill-form.py

f1040_data_fields: pdftk forms/f1040.pdf
	pdftk forms/f1040.pdf dump_data_fields > build/f1040_data_fields
