...
build/tax-return.pdf: forms $(data)/f1040 $(data)/f1040s1 $(data)/f1040s4 $(data)/f1040sc $(data)/f1040sse $(data)/f1040sd $(data)/f8949
	$(log_start)
...
$(data)/f2210: $(data)/f1040
	$(log_start)
	python ops/f2210.py $(data)/f1040.json $(data)
	touch $@
	$(log_finish)
